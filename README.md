...
The datasets here are **already harmonized** (e.g. derived from OpenDengue / CLIM-181 workflows) and are published in a format that can be consumed directly by the Climate Health Analytics Platform (Chap).
